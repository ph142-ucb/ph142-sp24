...
because we have not learned formally in this class how to assert that one is estimating causal effect (see Causal Inference in the Spring 2023!).
...
around the line of best fit (just like previously, we can loosen this assumption if sample size is "big enough" by inkoking the CLT). 
